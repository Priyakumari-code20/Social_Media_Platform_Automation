import { useState, type Dispatch, type SetStateAction, type ComponentType } from "react"
...
const SidebarWithProps = Sidebar as ComponentType<{
  isOpen: boolean
...
const Layout = () => {
  ...
  return (
    <div className='flex h-screen bg-slate-50'>
      ...
      <SidebarWithProps isOpen={isMobileMenuOpen} setIsOpen={setIsMobileMenuOpen}/>
